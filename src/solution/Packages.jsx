  ...
  return (
    <div id="packages " className='w-full bg-gray-200 flex flex-col justify-center items-center gap-10 lg:px-22 px-5 lg:py-22 py-20'>
      <div id="top" className="w-full flex lg:flex-row flex-col justify-between items-center lg:gap-20 gap-5">
        <div>
          <h1 data-aos="zoom-in" data-aos-delay="100" className="lg:text-5xl text-3xl font-fakhwang  font-semibold text-black "> Explore our most popular tour packages </h1>

        </div>
        <div className="flex flex-col justify-between items-start gap-7">
          <p data-aos="zoom-in" data-aos-delay="200" className="text-gary-500 w-full text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic illum magnam enim unde voluptatem fuga corrupti animi delectus, nesciunt dolorem velit fugit necessitatibus quo, nam rerum quaerat eos natus iusto.
                ...
                <div id='content-box ' className="w-full flex flex-col justify-between items-start bg-white p-7 gap-5">
                 ...
                 <div className="w-full flex justify-start  items-center gap-5">
                  <span className="flex justify-between items-center gap-1">
                    <MdOutlineDateRange className="text-orange-600  text-xl "></MdOutlineDateRange>
                    <p>{item.days}</p>
                  </span>
                  <span classNsme="flex justify-between items-center gap-1">
                    <FaUsers className="text-orange-600 text-xl "/>
                    <p>{item.pax}</p>
                  </span>
                  </div>
                  <div className="text-gray-500 ">{item.about}</div>
                  <button className='bg-orange-600 hover:bg-black w-full text-white px-8 py-3 font-semibold capitalize rounded-md mt-5 cursor-pointer '>
                    {item.btn}
                    </button> 
                  </div>
                  </div>
